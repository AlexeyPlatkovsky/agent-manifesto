...
- `workflows/*.yml`: framework procedures
- `skills/*/SKILL.md`: reusable task-scoped policies
- `agents/*.md`, excluding `agents/_README.md`: fresh-context responsibility templates
...
- `inputs` lists the files needed to start; referenced skills, agents, and contracts load only when their step is eligible
